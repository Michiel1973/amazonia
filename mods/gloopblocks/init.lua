...
minetest.register_tool("gloopblocks:pick_cement", {
	...
	tool_capabilities = {
		...
		max_drop_level=1,
		groupcaps={
			cracky={times={[1]=3.50, [2]=1.40, [3]=0.90}, uses=25, maxlevel=3}
		},
...
minetest.register_tool("gloopblocks:shovel_cement", {
	...
	tool_capabilities = {
		...
		max_drop_level=1,
		groupcaps={
			crumbly={times={[1]=1.50, [2]=0.60, [3]=0.45}, uses=25, maxlevel=3}
		},
		damage_groups = {fleshy=4},
	},
})
...
minetest.register_tool("gloopblocks:axe_cement", {
	...
	tool_capabilities = {
		...
		max_drop_level=1,
		groupcaps={
			choppy={times={[1]=3.00, [2]=1.30, [3]=0.80}, uses=25, maxlevel=3},
...
minetest.register_tool("gloopblocks:sword_cement", {
	...
	tool_capabilities = {
		...
		max_drop_level=1,
		groupcaps={
			fleshy={times={[1]=1.60, [2]=0.80, [3]=0.40}, uses=15, maxlevel=3},
