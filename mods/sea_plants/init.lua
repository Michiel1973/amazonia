...
minetest.register_node("sea_plants:kelpgreen", {
	...
	waving = 1,
    special_tiles = {{name = "seaplants_kelpgreen.png", tileable_vertical = false}},
...
minetest.register_node("sea_plants:kelpgreenmiddle", {
	...
	waving = 1,
	tiles = {"default_sand.png"},
    special_tiles = {{name = "seaplants_kelpgreenmiddle.png", tileable_vertical = false}},
...
minetest.register_node("sea_plants:kelpbrown", {
	...
	drawtype = "plantlike_rooted",
	tiles = {"default_sand.png"},
    special_tiles = {{name = "seaplants_kelpbrown.png", tileable_vertical = false}},
...
minetest.register_node("sea_plants:kelpbrownmiddle", {
	...
	drawtype = "plantlike_rooted",
	tiles = {"default_sand.png"},
    special_tiles = {{name = "seaplants_kelpbrownmiddle.png", tileable_vertical = false}},
...
minetest.register_node("sea_plants:seagrassgreen", {
	...
	waving = 1,
	tiles = {"default_sand.png"},
    special_tiles = {{name = "seaplants_seagrassgreen.png", tileable_vertical = false}},
...
minetest.register_node("sea_plants:seagrassred", {
	...
	waving = 1,
	tiles = {"default_sand.png"},
    special_tiles = {{name = "seaplants_seagrassred.png", tileable_vertical = false}},
...
minetest.register_craft({
	...
	recipe = {"sea_plants:kelpbrown", "sea_plants:seagrassgreen", "sea_plants:seagrassred"}
})

-- register_seaplant_craft = function(output,recipe)
    	-- minetest.register_craft({
        -- type = 'shapeless',
        -- output = output,
        -- recipe = recipe,
...
-- register_seaplant_craft('dye:cyan 1', {'seacoral:coralcyan'})
-- register_seaplant_craft('dye:magenta 1', {'seacoral:coralmagenta'})
-- register_seaplant_craft('dye:lime 1', {'seacoral:corallime'})
-- register_seaplant_craft('dye:aqua 1', {'seacoral:coralaqua'})
-- register_seaplant_craft('dye:green 1', {'sea_plants:kelpgreen'})
-- register_seaplant_craft('dye:redviolet 1', {'sea_plants:seagrassred'})
-- end
...
action = function(pos, node, active_object_count, active_object_count_wider)
	...
	if (active_object_count_wider + active_object_count_wider) > 10 then
		return
			elseif (minetest.get_node(yp).name == "default:water_source")
	or (minetest.get_node(yp).name == "default:river_water_source") then
		--pos.y = pos.y - 1
...
action = function(pos, node, active_object_count, active_object_count_wider)
	...
	if (active_object_count_wider + active_object_count_wider) > 10 then
		return
			elseif (minetest.get_node(yp).name == "default:water_source")
	or (minetest.get_node(yp).name == "default:river_water_source") 
	then
		--pos.y = pos.y - 1
		minetest.add_node(pos, {name = "sea_plants:seagrassgreen"}) 
		else
		return
	end
end
...
action = function(pos, node, active_object_count, active_object_count_wider)
	...
	then
		--pos.y = pos.y - 1
		minetest.add_node(pos, {name = "sea_plants:seagrassred"}) 
		else
		return
	end
end
