...
regional_weather.settings.snow					= get_setting_bool("snow_layers", false)
...
regional_weather.settings.soil					= get_setting_bool("soil", false)
regional_weather.settings.fire					= get_setting_bool("fire", false)
regional_weather.settings.ice						= get_setting_bool("ice", false)
