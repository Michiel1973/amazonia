...
local speed         = tonumber(setting_get("sprint_speed", "2.0"))
...
local stamina_drain = tonumber(setting_get("sprint_stamina_drain", "1.5"))
local stamina_heal  = tonumber(setting_get("sprint_stamina_heal", "2.5"))
local standing      = tonumber(setting_get("sprint_stamina_standing", "4"))
...
local starve_drain  = tonumber(setting_get("sprint_starve_drain", "0.2"))
