local ALTITUDE               = 500      -- average altitude of islands
local ALTITUDE_AMPLITUDE     = 50       -- rough island altitude variance (plus or minus)
...
local LOWLAND_BIOME_ALTITUDE = 6       -- Higher than beaches, lower than mountains (See LOWLAND_BIOMES)
