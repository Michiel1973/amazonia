...
-- The code below was shamelessly stolen from minetest_game
-- Originally written by blockmen, sofar, paramat, JustinLaw64


local function on_flood(pos, oldnode, newnode)
	minetest.add_item(pos, ItemStack("glooptest:kalite_torch 1"))
...
minetest.register_node("glooptest:kalite_torch", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if wdir == 0 then
			fakestack:set_name("glooptest:kalite_torch_ceiling")
		elseif wdir == 1 then
			fakestack:set_name("glooptest:kalite_torch")
		else
			fakestack:set_name("glooptest:kalite_torch_wall")
		end

		itemstack = minetest.item_place(fakestack, placer, pointed_thing, wdir)
		itemstack:set_name("glooptest:kalite_torch")
...
minetest.register_node("glooptest:kalite_torch_wall", {
	drawtype = "mesh",
	mesh = "torch_wall.obj",
	tiles = {{
		    name = "gloopores_kalite_torch_on_floor_animated.png",
...
minetest.register_node("glooptest:kalite_torch_ceiling", {
	drawtype = "mesh",
...
minetest.register_lbm({
	name = "glooptest:3dtorch",
	nodenames = {"glooptest:kalite_torch", "gloopores:kalite_torch"},
	action = function(pos, node)
		if node.param2 == 0 then
			minetest.set_node(pos, {name = "glooptest:kalite_torch_ceiling",
				param2 = node.param2})
		elseif node.param2 == 1 then
			minetest.set_node(pos, {name = "glooptest:kalite_torch",
				param2 = node.param2})
		else
			minetest.set_node(pos, {name = "glooptest:kalite_torch_wall",
				param2 = node.param2})
		end
	end
})
