...
minetest.register_decoration({
	deco_type = "simple",
	place_on = {"default:dirt_with_rainforest_litter", "aotearoa:forest_peat", "aotearoa:dirt_with_dry_litter", "aotearoa:dirt_with_dark_litter"},
	sidelen = 16,
	fill_ratio = 0.02,
	-- biomes = {"rainforest"},
...
minetest.register_decoration({
	deco_type = "simple",
	place_on = {"default:dirt_with_rainforest_litter", "default:dirt_with_rainforest_litter", "aotearoa:dirt_with_dark_litter", "aotearoa:forest_peat"},
	sidelen = 16,
	fill_ratio = 0.01,
...
minetest.register_decoration({
	deco_type = "simple",
	place_on = {"default:dirt_with_rainforest_litter", "aotearoa:forest_peat"},
	sidelen = 16,
	fill_ratio = 0.01,
	--biomes = {"rainforest"},
...
minetest.register_decoration({
	deco_type = "simple",
	place_on = {"ethereal:crystal_dirt","ethereal:jungle_dirt"},
	sidelen = 16,
	fill_ratio = 0.005,
	--biomes = {"tundra"},
...
minetest.register_decoration({
	deco_type = "simple",
	place_on = {"aotearoa:forest_peat","aotearoa:dirt_with_beech_litter","aotearoa:dirt_with_moss"},
	sidelen = 16,
	fill_ratio = 0.01,
...
minetest.register_decoration({
	deco_type = "simple",
	place_on = {"aotearoa:forest_peat","aotearoa:dirt_with_beech_litter","aotearoa:dirt_with_moss","ethereal:jungle_dirt","default:dirt_with_rainforest_litter", "aotearoa:dirt_with_dark_litter"},
	sidelen = 16,
	fill_ratio = 0.007,
	--biomes = {"deciduous_forest"},
