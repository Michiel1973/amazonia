...
setting("int", "ymax", -10033, "Upper limit of level 1")
setting("int", "level1_min", -12032, "Upper limit of level 2")
setting("int", "level2_min", -14032, "Upper limit of level 3")
setting("int", "level3_min", -15072, "Upper limit of the sunless seas")
setting("int", "sunless_sea_min", -15552, "Lower limit of the sunless seas")
...
setting("int", "oil_sea_level", -16000, "Oil sea level")

setting("bool", "enable_lava_sea", true, "Enable magma sea")
setting("int", "lava_sea_level", -17000, "Lava sea level")
...
setting("int", "underworld_level", -18000, "Underworld level")
