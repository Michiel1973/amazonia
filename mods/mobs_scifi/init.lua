...
mobs:register_mob("scifi_mobs:cyberman", {
   ...
   sounds = {
	...
	-- replace_rate = 0,
	-- replace_what = {
		-- {"cratermg:dust", "cratermg:dusttrack", -1}
	-- },
	animation = {
		speed_normal = 10,
		speed_run = 10,
...
--mobs:register_spawn("scifi_mobs:core", {"cratermg:dust",}, 0, 14, 15000, 2, 31000)
